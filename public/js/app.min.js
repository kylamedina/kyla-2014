...
(function(){var KM,backToTop,cacheArray,closeMarkers,fixie,footer,foreverScroll,imgArray,imgFadeIn,loadNewPage,markerScroll,markers,openMarkers,packery,pageLoaded,runHome,runProjects,stopMarkerScroll,wh,ww;KM={};KM.Utils={};ww=$(window).width();wh=$(window).height();$.fn.scrollStopped=function(callback){$(this).scroll(function(){var $this,self;self=this;$this=$(self);if($this.data("scrollTimeout")){clearTimeout($this.data("scrollTimeout"))}$this.data("scrollTimeout",setTimeout(callback,250,self))})};$("body").on("click","[data-page='projects']",function(e){e.preventDefault();if($("body").hasClass("ajax-projects")){return $("html,body").animate({scrollTop:$("#top").offset().top},700)}else{$("html,body").scrollTop($("#top").offset().top);loadNewPage();return $.ajax({url:"/projects",data:{order:$(this).attr("data-order")},cache:true,success:function(data){$(".view-main").html(data);$("body").removeClass("ajax-home").addClass("ajax-projects");runProjects();$(".fixie").width($(".project-desc").width());return pageLoaded()}})}});$("body").on("click","[data-page='home']",function(e){e.preventDefault();if($("body").hasClass("ajax-home")){return $("html,body").animate({scrollTop:$("#top").offset().top},700)}else{loadNewPage();return $.ajax({url:"/home",cache:true,success:function(data){$(".view-main").html(data);$("html,body").scrollTop($("#top").offset().top);$("body").removeClass("ajax-projects").addClass("ajax-home");runHome();return pageLoaded()}})}});loadNewPage=function(){return $(".view-main").addClass("is-loading")};pageLoaded=function(){return $(".view-main").removeClass("is-loading")};packery=function(){var homeGrid,pckry;homeGrid=document.querySelector(".grid");pckry=new Packery(homeGrid,{itemSelector:".grid-item",isFitWidth:true,isHorizontal:false,columnWidth:".grid-sizer",rowHeight:0,gutter:30,isInitLayout:true,isResizeBound:true,transitionDuration:"0.3s"});return pckry.layout()};foreverScroll=function(){return $(".spawn").waypoint({continuous:false,triggerOnce:true,handler:function(down){if($(".view-main").children().length>15){$.waypoints("disable");$(".clone").remove();$.waypoints("enable")}return $(".spawn").addClass("clone").removeClass("spawn").clone().appendTo(".view-main").addClass("spawn").removeClass("clone")}})};backToTop=function(){return $('a[href^="#"]').click(function(e){$("html,body").animate({scrollTop:$(this.hash).offset().top},700);$(".clone").remove();return false;return e.preventDefault()})};imgFadeIn=function(){return $("img").waypoint({offset:wh-wh/9,handler:function(direction){if(direction==="down"){return $(this).css("opacity",1)}}})};fixie=function(){$(".fixie").width($(".project-desc").width());return $(".fixie").fixer({gap:118})};$("body").on("click",".activate-panel",function(){if($("body").hasClass("panel-is-open")){return $("body").removeClass("panel-is-open")}else{return $("body").addClass("panel-is-open")}});footer=function(){return $(window).on("scroll",function(){if($(window).scrollTop()+$(window).height()>$(document).height()-80){return $("body").addClass("footer-is-showing")}else{return $("body").removeClass("footer-is-showing")}})};markerScroll=function(){return $(".fixie").waypoint({offset:144,handler:function(direction){var markerID;({context:".project"});markerID=$(this).data("marker").toString();$(".marker").removeClass("is-active");return $("."+markerID).addClass("is-active")}})};openMarkers=function(){return $(".ajax-projects").removeClass("markers-hidden").addClass("markers-visible")};closeMarkers=function(){return $(".ajax-projects").removeClass("markers-visible").addClass("markers-hidden")};markers=function(){return $(".project-markers, button.fixed-right").on("mouseover",function(){return openMarkers()})};stopMarkerScroll=function(){return $(window).scrollStopped(function(){closeMarkers()})};$(window).on("scroll",function(){$(".fixie").width($(".project-desc").width());if(head.desktop&&ww>640){foreverScroll();openMarkers()}if($(window).scrollTop()>50){$(".header-main h1").removeClass("at-top").addClass("scrolling")}else{$(".header-main h1").removeClass("scrolling").addClass("at-top")}if($(window).scrollTop()>150){$(".back-top-container").css("opacity","1")}else{$(".back-top-container").css("opacity","0")}});$(window).on("resize",function(){$(".fixie").width($(".project-desc").width());if(ww<641){return footer()}});cacheArray=function(){var i,img,url,_results;i=0;_results=[];while(i<imgArray.length){url=imgArray[i];img=new Image;img.src=url;_results.push(i++)}return _results};imgArray=["img/projects/artnet_01.min.png","img/projects/artnet_02.min.png","img/projects/clear_01.min.png","img/projects/ihny_01.min.png","img/projects/ihny_02.min.png","img/projects/ihny_03.min.png","img/projects/rms_01.min.png","img/projects/rms_02.min.png","img/projects/rms_03.min.png","img/projects/sa_01.min.png","img/projects/sa_02.min.png","img/projects/sa_03.min.png","img/projects/sa_04.min.png","img/projects/sa_05.min.png","img/projects/vse_01.min.png","img/projects/vse_02.min.png"];runHome=function(){packery();return backToTop()};runProjects=function(){imgFadeIn();fixie();footer();markers();markerScroll();stopMarkerScroll();return backToTop()};$(document).ready(function(){$(".clone").remove();return $("h1").addClass("at-top")});$(window).on("load",function(){runHome();pageLoaded();cacheArray();if(ww<641){return footer()}})}).call(this);